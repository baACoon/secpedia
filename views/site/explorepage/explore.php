...
$this->registerCssFile('@web/css/newarticles/newarticles.css')
?>
...
<main class="explorepage">  
    ...
    <div class="content-section" id="articleSection">
        <h6>New Articles</h6>
        <?php foreach (['Article Title I', 'Article Title II', 'Article Title III'] as $articleTitle): ?>
        <div class="articlecontainer">
            <div class="articleleft">
                <img src="../images/chairperson.jpg" alt="" class="articleImage">
            </div>
            <div class="articleright">
                <h2 class="articletitle"><?= Html::encode($articleTitle) ?></h2>
